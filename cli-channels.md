---
title: CLI Channels
description: Turn the Inference Gateway CLI agent into a remote-controllable bot over Telegram, with per-sender sessions, allowlist access control, tool approval prompts, and image attachments.
---
