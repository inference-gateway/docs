...
<ConfigTable rows={[
  ...
  { variable: "ENABLE_TELEMETRY", description: "Enable OpenTelemetry metrics and tracing", defaultValue: "false" },
...
<ConfigTable rows={[
  { variable: "OIDC_ISSUER_URL", description: "OIDC issuer URL", defaultValue: "http://keycloak:8080/realms/inference-gateway-realm" },
  { variable: "OIDC_CLIENT_ID", description: "OIDC client ID", defaultValue: "inference-gateway-client" },
...
<ConfigTable rows={[
  { variable: "COHERE_API_URL", description: "Cohere API URL", defaultValue: "https://api.cohere.com" },
