...
description: Synthesize speech from text in the Inference Gateway CLI with a local llama.cpp llama-tts binary and Qwen3-TTS GGUF models - stock voices or zero-shot voice cloning from a reference WAV, fully offline.
---
