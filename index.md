...
hero:
  ...
  tagline: Open-source, cloud-native proxy unifying OpenAI, Anthropic, Groq, Cohere, Ollama, Ollama Cloud, DeepSeek, Cloudflare, Google, Mistral, MiniMax, Moonshot, Nvidia and llama.cpp behind a single OpenAI-compatible API.
  image:
    src: /logo.png
